...
if ([string]::IsNullOrWhiteSpace($PackagePath)) {
  $PackagePath = Join-Path $module 'tb\ub02_pkg.sv'
}
...
& $runner -ModuleId 'UB-02' -ModuleDirectory $module -Sources $sources `
  -Top 'tb_top' -Snapshot 'ub02_snapshot' -Test 'ub02_test' -Seed $Seed `
