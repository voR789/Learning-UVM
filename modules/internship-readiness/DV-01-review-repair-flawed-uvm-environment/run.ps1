[CmdletBinding()]
param(
    [ValidateSet('dv01_test')]
    [string]$Test = 'dv01_test',
    [int]$Seed = 1,
    [string]$PackagePath = '',
...
if ([string]::IsNullOrWhiteSpace($PackagePath)) {
    $PackagePath = Join-Path $moduleDirectory 'tb\dv01_pkg.sv'
}
...
& $runner -ModuleId 'DV-01' -ModuleDirectory $moduleDirectory -Sources $sources `
    -Top 'tb_top' -Snapshot 'dv01_snapshot' -Test $Test -Seed $Seed `
